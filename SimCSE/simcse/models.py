...
from transformers import CLIPPreTrainedModel, CLIPTextModel, CLIPModel
...
def cl_forward(cls,
    ...
    # print("cosine sim")
    # print(cos_sim) ## Issue here

    # print("labels")
    # print(labels) ## no issue with labels
...
class RobertaForCL(CLIPTextModel):
    ...
    def __init__(self, config, *model_args, **model_kargs):
        ...
        cl_init(self, config.text_config)
    ...
    def forward(self,
        ...
        if sent_emb:
            return sentemb_forward(self, self.text_model,
                input_ids=input_ids,
                attention_mask=attention_mask,
                token_type_ids=token_type_ids,
                position_ids=position_ids,
